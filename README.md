...
### du
* df -h -> para ver as partições do disco  
* diretorio dev mostra os dispositivos, o sistema usa para escrever no disco  
* sudo du -sh /home -> Para saber o tamanho total das pastas, incluindo subpastas  
* sudo du -Ssh /home -> Para saber o tamanho da raiz da pasta, sem incluir as subpastas  
* sudo du -Sh /var |sort -nr -> || mostrando o valor em numero em ordem contraria(crescente)  

### Rede
* cd /etc/netplan -> rodando ls dentro do diretorio podemos ver o arquivo de configuração do IP "00-installer-config.yaml"  
* Ubuntu Linux antes de 2018 econtramos o arquivo no network  
